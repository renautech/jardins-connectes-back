...
operationTypeRouter.get('/', cache, mainController.findAll(Operation_type));                    //isAdmin ??
operationTypeRouter.get('/operation_type/:id', cache, mainController.findOne(Operation_type));  //isAdmin ??
